...
public class TestFriendController {
    ...
    public void getAllFriends() {
        ResponseEntity<List<FriendDTO>> stringResponseEntity = friendController.getAllFriends(getAuthentication(accessTokenOneUser));
    ...
    public void deleteFriends() {
        ...
        Assertions.assertEquals(friendController.deleteFriends(friendToId, getAuthentication(accessTokenOneUser)).getStatusCode(), HttpStatus.OK);
    }
