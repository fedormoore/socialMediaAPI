...
public class TestSubscriberController {
    ...
    static ResponseEntity<List<SubscriberDTO>> stringResponseEntity;
    ...
    public void getAllSubscribers() {
        stringResponseEntity = subscriberController.getAllSubscribers(getAuthentication(accessTokenOneUser));
    ...
    public void deleteSubscribers() {
        Assertions.assertEquals(subscriberController.deleteSubscribers(stringResponseEntity.getBody().get(0).getId(), getAuthentication(accessTokenOneUser)).getStatusCode(), HttpStatus.OK);
    }
